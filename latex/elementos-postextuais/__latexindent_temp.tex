...
@book{Pozo,
author = {Pozo, Juan and ángel Gómez Crespo, Miguel},
year = {1998},
month = {01},
title = {Aprender y enseñar ciencia : del conocimiento cotidiano al conocimiento científico},
journal = {http://www.redined.mec.es/oai/indexg.php?registro=008199920309}
}

@book{Claxton,
  title={Live and Learn: An Introduction to the Psychology of Growth and Change in Everyday Life},
  author={Claxton, G.},
  isbn={9780063182776},
  lccn={gb84001257},
  url={https://books.google.ae/books?id=ht0NAAAAMAAJ},
  year={1984},
...
@article{Lee2011,
abstract = {Abstract Computational thinking (CT) has been described as the use of abstraction, automation, and analysis in problem-solving [3]. We examine how these ways of thinking take shape for middle and high school youth in a set of NSF-supported programs. We ...$\backslash$n},
