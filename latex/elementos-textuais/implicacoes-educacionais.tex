...
Além disso, o autor acredita os \textit{insights} proporcionados por essas tarefas favorecem o desenvolvimento de um ``senso profundo e intuitivo'' do comportamento de um sistema de partículas, facilitando, por exemplo, a previsão de outros comportamentos, mesmo estando ele em estado sólido ou líquido. 
