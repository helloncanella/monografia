...
No terceiro e último capítulo, a nossa preocupação recai sobre a implicação e aplicação desse conceito para a aprendizagem científica. Baseando-nos na contribuição de \citeonline{Weintrop2016}, iremos tentar distinguir exatamente quais \textit{expertises} científicas buscamos que os alunos exercitem e desenvolvam quando propomos que eles pensem ``computacionalmente''. Ao final, iremos apresentar um conjunto de três atividades de fácil execução em sala de aula, cuja finalidade é o exercício de algumas dessas competências. 
