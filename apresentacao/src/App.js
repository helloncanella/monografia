    ...
    return (
      <div className="App">
        ...
        **/}
            ...
            {[
              [
                `<strong>Problemas do mundo real</strong> necessitam ser expressos como <strong>problemas computacionais</strong>, para receberem tratamento computacional.`,

                `A resolução necessita então ser sequenciada - expressa em um <strong>algoritmo</strong>. `
              ],
              [
